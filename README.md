...
- ✅ **W-DS مقفلة بالكامل (Phase 0–6، آخرها اعتماد §7.8 في 2026-09-25)** — نظام تصميم واحد مقيس ومحروس بثلاثة حراس في CI (G-7 ratchet · مسبار G-6 · مصفوفة الاعتماد §5).
- ✅ **W-6 نسجام الصفحات منفذة ومقاسة (2026-09-25):** عنوان صفحة واحد (h1 على مستوى سلّم واحد عبر 19 مسارًا) · إيقاع أقسام واحد لكل العائلات · معالجة تركيز واحدة · تابلت بشريط موسّع بمُسميات (D-2).
- 🎯 **القرار التالي للمالك:** جدولة W-4 (الحفظ والاستئناف الحقيقيان) أو موجة نسجام تالية (VIS-02 الأدوار الدلالية للألوان أكبرها) — [roadmap](./docs/05-process/roadmap.md).
